<?php
        ...
        $id = $_GET['id'];
        $city = mysqli_query($connect, "SELECT `id`, `name` FROM `city` WHERE `id` = '$id'");
    ...
    <script>
        $(function(){
            ...
            $('.close-button').click(function(){
               ...
               // $(location).attr('href',"city_index.php");
            });
...
<body>
    <div class="up-form-layout">
        <form class="up-form-adding" action="vendor/update_city.php" method="post">
            <a href="#" class="up-close-button"></a>
            <h3>Внести попраки</h3>
            <label>               <input type="hidden" name="id" value="<?= $cit[0] ?>">
                Название города : <input class="city" type="text" name="city" value="<?= $cit[1] ?>">
            </label>
...
-->
        ...
        <div class="box">
            <a href="index_adm.php">Обоненты</a>
        </div>
        <!--<div class="box">
            <a href="">Инструкция</a>
        </div>
